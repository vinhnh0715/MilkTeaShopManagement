...
public class ManageProductsController extends HttpServlet {
    ...
    private static final String ERROR="adminPage_2.jsp";
    private static final String SUCCESS="adminPage_2.jsp";
...
//            UserDTO loginUser=(UserDTO) session.getAttribute("LOGIN_USER");
            ...
            List<TeaDTO> listTea=dao.getAllTea();
            request.setAttribute("LIST_TEA", listTea);
            url=SUCCESS;
        } catch (Exception e) {
            log("Error at SearchUsersController " + e.toString());
        }finally{
